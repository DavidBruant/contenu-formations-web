...
function getCommits() {
	...
	var allCommits = Promise.all([_commits1, _commits2]).then(function (_ref) {
		var _ref2 = _slicedToArray(_ref, 2),
		    commits1 = _ref2[0],
		    commits2 = _ref2[1];

		return [].concat(_toConsumableArray(commits1), _toConsumableArray(commits2));
	});
	return allCommits;
};
...
document.addEventListener('DOMContentLoaded', function () {
	...
	(0, _getCommits2.default)().then(function (commits) {
		...
		(0, _createCharts2.default)(weekDays, commits);
	});
});
