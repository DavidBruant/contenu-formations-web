...
document.addEventListener('DOMContentLoaded', function () {
	...
	(0, _getCommits2.default)().then(function (commits) {
		var commitsDate = commits.map(function (commit) {
			return (0, _moment2.default)(commit.commit.author.date).format('dddd');
		});
