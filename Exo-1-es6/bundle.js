...
function getTweets() {
	...
	var allTweets = Promise.all([twentyTweetsP, hundredTweetsP]).then(function (_ref) {
		...
		return [].concat(_toConsumableArray(twentyTweets), _toConsumableArray(hundredTweets));
	});
