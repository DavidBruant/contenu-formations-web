...
exports.default = createClickButton;
function createClickButton() {
    ...
    var mouseDownTime = void 0,
        tempsClic1 = void 0;

    clickButton.addEventListener('mousedown', function (evt) {
...
function getTweets() {
	...
	var twentyTweetsP = fetch('https://rawgit.com/DavidBruant/contenu-formations-web/master/js/data/tweets.json').then(function (resp) {
		return resp.json();
	});
	var hundredTweetsP = fetch('https://rawgit.com/DavidBruant/contenu-formations-web/master/js/data/tweets2.json').then(function (resp) {
		return resp.json();
	});

	var allTweets = Promise.all([twentyTweetsP, hundredTweetsP]).then(function (_ref) {
		var _ref2 = _slicedToArray(_ref, 2),
		    twentyTweets = _ref2[0],
		    hundredTweets = _ref2[1];
...
var _tweetOl = require('./tweetOl.js');

var _tweetOl2 = _interopRequireDefault(_tweetOl);

var _clickTimer = require('./clickTimer.js');

var _clickTimer2 = _interopRequireDefault(_clickTimer);

var _getTweets = require('./getTweets.js');

var _getTweets2 = _interopRequireDefault(_getTweets);
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var monBouton = (0, _clickTimer2.default)();
    ...
    (0, _getTweets2.default)().then(function (tweets) {
        ...
        var tweetsContainer = (0, _tweetOl2.default)(tweets);
...

        {
            (function () {
                ...
                frButton.addEventListener('click', function (evt) {

                    var listCreator = void 0;
                    mainWrapper.innerHTML = '';

                    if (!onlyFr) {
                        listCreator = (0, _tweetOl2.default)(tweetsFr);
                    } else {
                        listCreator = (0, _tweetOl2.default)(tweets);
                    }
...
},{"./clickTimer.js":1,"./getTweets.js":2,"./tweetOl.js":5}],4:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
	value: true
});
exports.default = createTweetLi;
...
function createTweetLi(tweet) {
	...
	var tweetTime = (0, _moment2.default)(tweet.created_at).fromNow();
	var tweetAuthor = tweet.user.name;
...
exports.default = createTweetsOl;

var _tweetLi = require('./tweetLi.js');

var _tweetLi2 = _interopRequireDefault(_tweetLi);
...
function createTweetsOl(tweets) {
	...
	tweets.forEach(function (tweet) {
		var li = (0, _tweetLi2.default)(tweet);
		listContainer.appendChild(li);
	});
	return listContainer;
};

},{"./tweetLi.js":4}],6:[function(require,module,exports){
//! moment.js
//! version : 2.15.2
