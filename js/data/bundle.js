...
function getCommitDay(commits, day){
  var nbCommit = 0;
...
function createDonuts(data, weekday){
  ...
  arcs.forEach(function(e){
    ...
    text.setAttributeNS(null, "x", (arc$$1.centroid()[0])-30);
    text.setAttributeNS(null, "y", arc$$1.centroid()[1]);
    ...
    path.setAttributeNS(null, "d", arc$$1());
