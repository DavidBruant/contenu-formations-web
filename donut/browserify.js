...
function makeDonut(jourSemaine){
	var width = 960,
	    height = 500,
    ...
    Object.keys(jourSemaine).forEach(function(jour){
    	...
    	var arc$$1 = d3.arc()({outerRadius :(radius - 10),innerRadius :(radius - 70),startAngle :(data[i].startAngle),endAngle :(data[i].endAngle)});
	    console.log(arc$$1);

	    path.setAttribute('d', arc$$1);
