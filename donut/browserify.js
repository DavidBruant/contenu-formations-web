...
function createLi(tweets){
    var li = document.createElement('li');
    var span = document.createElement('span');
    var br = document.createElement('br');

    span.textContent = moment(tweets.created_at).fromNow(),
    li.textContent = tweets.text;
    li.append(br);
    li.append(span);
    return li;
}

function createOl(tweets, lang){
...
function getTweets(){
	...
	var p1 = fetch('https://rawgit.com/DavidBruant/contenu-formations-web/master/js/data/tweets2.json')
	...
	var p2 = fetch('https://rawgit.com/DavidBruant/contenu-formations-web/master/js/data/tweets2.json')
	.then(function(resp){return resp.json()})
	.catch(function(e){
	    console.error(e);
	});
...
getTweets().then(function(tweets){
        document.body.appendChild(createOl(tweets, ''));
        ...
        document.getElementById('buttonFR').addEventListener('click', function(){
            ...
            if (swap){                        
                ...
                document.body.appendChild(createOl(tweets, 'fr'));
                swap = 1;
            }
        });          "use strict";
